      ...
      {options &&
        options.map((option) => (
          <Button
            ...
            type='button'
            className={twMerge(
              'ring-1 ring-zinc-300 text-zinc-600 font-normal capitalize px-2 py-1 rounded-lg hover:bg-zinc-50 bg-white transition-all duration-300 ease-in-out sm:text-sm',
